...
(function () {
  const ACAO_POR_ONCLICK = [
    ...
    { padrao: "navegarPara('performance')", acao: 'visualizar_performance_operacional' },
    ...
    { padrao: 'selecionarArquivoPerformance', acao: 'importar_performance_operacional' },
    { padrao: 'confirmarImportacaoPerformance', acao: 'importar_performance_operacional' },
